 ...
 * @author lenovo
 */
public class UpdateCampLocation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         try {
           ...
           String areaname = request.getParameter("ucamplocation");
           String connectionString = "jdbc:mysql://localhost:3306/blooddonation?zeroDateTimeBehavior=CONVERT_TO_NULL";
            ...
            Connection con = DriverManager.getConnection(connectionString, "root", "");
             ...
             stmt.executeUpdate("UPDATE `area` SET `areaname`='"+ areaname +"' WHERE id = 1");
